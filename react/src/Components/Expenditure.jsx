  ...
  return (
    <div className="mt-4">
      <div className="d-flex justify-content-center align-items-start">
        ...
        <h1 className="h1 text-center text-light pb-4">Expenditure</h1>
      </div>
      ...
      <div className="container col-11">
        <ul className="list-group border border-danger">
          {transactions
            ...
            .map((transaction) => (
              <li
                className="list-group-item border border-danger d-flex justify-content-between align-items-center bg-dark text-light fs-5"
                key={transaction._id}
              >
